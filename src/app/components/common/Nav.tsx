  ...
  return (
    <>
      <div className="bg-skyblue py-5 rounded-b-3xl max-lg:hidden">
        <div className="container 3xl:max-w-[1560px] 2xl:max-w-[1400px] max-w-[1200px] flex items-center lg:justify-between justify-center lg:flex-row flex-col gap-y-5">
